...
iptables -A OUTPUT -s 10.0.0.12/32 -d 10.0.0.4/32 -p tcp --sport 1024:65535 --dport 443 -m state --state NEW,ESTABLISHED -j ACCEPT
...
iptables -A OUTPUT -s 10.0.0.12/32 -d 10.0.0.13/32 -p tcp --sport 1024:65535 --dport 443 -m state --state NEW,ESTABLISHED -j ACCEPT
