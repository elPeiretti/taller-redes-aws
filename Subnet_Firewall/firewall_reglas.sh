...
iptables -t nat -A PREROUTING -p tcp -d 10.0.0.100 --dport 30:65535 -i eth0 -j DNAT --to-destination 10.0.0.39
iptables -t nat -A POSTROUTING -p tcp -s 10.0.0.39 --sport 30:65535 -o eth0 -j SNAT --to-source 10.0.0.100

iptables -A FORWARD -p tcp -s 0.0.0.0/0 -d 10.0.100.39/32 --sport 1024:65535 --dport 51820 -m state --state NEW,ESTABLISHED -j ACCEPT 
iptables -A FORWARD -p tcp -s 10.0.100.39 -d 0.0.0.0/0 --sport 51820 --dport 1024:65535 -m state --state ESTABLISHED -j ACCEPT 