...
iptables -t nat -A PREROUTING -p tcp -d 10.0.0.100 -i eth0 -j DNAT --to-destination 10.0.0.39
iptables -t nat -A POSTROUTING -p tcp -s 10.0.0.39 -o eth0 -j SNAT --to-source 10.0.0.100
--dport 51820 
--sport 51820 
