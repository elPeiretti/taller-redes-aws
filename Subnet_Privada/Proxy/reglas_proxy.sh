...
iptables -A INPUT -p tcp -s 10.0.0.54/32 -d 10.0.0.28/32 --sport 22 --dport 1024:65535 -m state --state NEW,ESTABLISHED -j ACCEPT
iptables -A OUTPUT -p tcp -s 10.0.0.28/32 -d 10.0.0.54/32 --sport 1024:65535 --dport 22 -m state --state ESTABLISHED -j ACCEPT
